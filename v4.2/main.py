...
wheel = Motor(Ports.PORT6, GearSetting.RATIO_6_1, False)
wing = Motor(Ports.PORT5, GearSetting.RATIO_18_1, False)
...
#
#   Project: scat v3.2
#   Author: virgilholmes and lalithahemanthkumar
#   Created: 10/9/23
#   Configuration:
#
# ------------------------------------------
...
wheel.set_velocity(300, PERCENT)
...
brain.screen.next_row()
brain.screen.print(" \__, |_/___|_| |_| |_|\___/ ")
brain.screen.next_row()
...
def autonomous():
 drivetrain.set_drive_velocity(120, PERCENT)
