...
helicopter = Motor(Ports.PORT4, GearSetting.RATIO_6_1, False)
...
right_motor_a = Motor(Ports.PORT10, GearSetting.RATIO_6_1, True)
right_motor_b = Motor(Ports.PORT20, GearSetting.RATIO_6_1, True)
right_drive_smart = MotorGroup(right_motor_a, right_motor_b)
drivetrain = DriveTrain(left_drive_smart, right_drive_smart, 319.19, 295, 40, MM, 1)
wing = Motor(Ports.PORT5, GearSetting.RATIO_6_1, False)
...
def rc_auto_loop_function_controller_1():
    ...
    while True:
        if remote_control_code_enabled:
            ...
            # to control helicopter
            if controller_1.buttonL1.pressing():
                helicopter.spin(FORWARD)
                controller_1_left_shoulder_control_motors_stopped = False
            elif controller_1.buttonL2.pressing():
                helicopter.spin(REVERSE)
                controller_1_left_shoulder_control_motors_stopped = False
